		...
		<div className="px-7 py-6">
			...
			<div className="flex flex-col gap-5 mb-5">
				{!dismissedBanners.has("cert") &&
					(!cert ? (
						<div
							className="flex items-center gap-3 px-3 py-2.5 rounded-[3px] bg-transparent text-error-text border border-[rgba(255,155,155,0.3)] font-mono cursor-pointer"
						...
						<div
							className="flex items-center gap-3 px-3 py-2.5 rounded-[3px] bg-transparent text-notice-text border border-notice-border font-mono cursor-pointer"
							style={{ fontSize: 12, letterSpacing: "0.04em", minHeight: 44 }}
							onClick={() => dismissBanner("cert")}
						>
				...
				{cert &&
					totalNeedReauth > 0 &&
					!dismissedBanners.has("reauth") && (
						<div
							className="flex items-center gap-3 px-3 py-2.5 rounded-[3px] bg-transparent text-warning-text border border-warning-border font-mono cursor-pointer"
							style={{ fontSize: 12, letterSpacing: "0.04em", minHeight: 44 }}
